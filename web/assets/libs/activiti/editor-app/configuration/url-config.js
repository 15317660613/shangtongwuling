...
KISBPM.URL = {
    ...
    getUser : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-user';
    },
    //获取角色列表，应用范围：任务受理人编辑和受理组编辑
    getRole : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-role/list';
    },
    //根据用户ID获取用户信息，应用范围：任务受理人展示
    getUserById : function (userId) {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-user/' + userId;
    },
    //根据角色ID获取角色信息，应用范围：受理组展示
    getRoleById : function (rId) {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-role/' + rId;
    },
    ...
    getOrgList : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-org/list';
    },
    //根据组织机构ID获得该机构下所有用户列表，应用范围：任务受理人编辑
    getUserByOrgId : function () {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-user/list-with-org';
    },
    //根据角色ID获得该角色下所有用户列表，应用范围：任务受理人编辑
    getUserByRoleId : function (rId) {
        return ACTIVITI.CONFIG.contextRoot + '/api/stwl-user/page/'+rId+'.do';
    },
    //获取跳转条件列表
