/** layui-v2.4.3 MIT License By https://www.layui.com   ADCDA-v3.02   cf  20190122 */
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    j.prototype.config = {
        ...
        a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            ...
            }), a.syncCheckAll(), a.renderForm("checkbox")) : (a.setCheckData(l, n), a.syncCheckAll()), layui.event.call(e[0], s, "checkbox(" + p + ")", v.call(e[0], {
                checked: n,
                type: o ? "all" : "one"
            }))
        ...
        a.layBody.on("change", "." + S, function () {
            //if (this.value.indexOf("\<\/script\>")!="-1") {alert("no!");return;}
            ...
            if (this.value.indexOf("\<script\>")!="-1"||this.value.indexOf("\<\/script\>")!="-1") {this.value="";alert("您正在尝试向当前页面注入脚本，请您停止这样的行为");}
        ...
        a.layBody.on("click", "." + g, function () {
            ...
            var e = t(this), i = e.scrollLeft(), n = e.scrollTop(),sc=e[0].parentElement.parentElement.parentElement.id;
            //记忆滚动条位置
            sessionStorage.setItem('scrollleft'+sc,i);
            sessionStorage.setItem('scrolltop'+sc,n);
        ...
        var a = c.config[e];
        return i = i || {}, a ? (i.data && i.data.constructor === Array && delete a.data, d.render(t.extend(!0, {},
            i.where ? function () {
                var newWhere = i.where;
                for (var index in newWhere){
                    if (newWhere[index] instanceof Array && a.where){
                        a.where[index] = newWhere[index];
                    }
                }
                return a;
            }() : a, i)
