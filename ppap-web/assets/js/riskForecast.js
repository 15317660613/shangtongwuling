layui.use(['index', 'laydate', 'form', 'table', 'formSelects', 'upload'], function() {
    ...
    laydate.render({
        ...
        type: 'month',
            ...
            admin.req("/smsh?re=task-remote-control/yc/" + selectDate, {}, function(res) {
                if (!res.ok) {
    ...
    laydate.render({
        ...
        type: 'month',
            ...
            var selectDate = date.year + (date.month < 10 ? '0' + date.month : date.month) + '01';
            admin.req("/smsh?re=/task-remote-control/fx/" + selectDate, {}, function(res) {
                if (!res.ok) {
                    return layer.msg(res.message);
                }
            });
    ...
    function setForecast(data) {
        admin.req("/api-edu/risk/riskPrediction", data, function(res) {
            if (res.ok) {
    ...
    function getBottomThreeChartOption(params, title) {
        ...
        var option = {
            ...
            color: ['#228fbd', '#7bbfea', '#426ab3', '#9999ff'],
            label: {
                formatter: function(data) {
            ...
            series: [{
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            tooltip: {
                                formatter: function(data) {
                                    return params[1].name + '：' + ((1 - data.value) * 100) + '%'
                                }
                            },
                ...
                },
                {
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            tooltip: {
                                formatter: function(data) {
                                    return params[2].name + '：' + ((1 - data.value) * 100) + '%'
                                }
                            },
                            itemStyle: placeHolderStyle
                        }
                ...
                },
                {
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            tooltip: {
                                formatter: function(data) {
                                    return params[3].name + '：' + ((1 - data.value) * 100) + '%'
                                }
                            },
                            itemStyle: placeHolderStyle
                        }
                ...
                },
                {
                    ...
                    data: [{
                        ...
                        },
                        {
                            ...
                            tooltip: {
                                formatter: function(data) {
                                    return params[0].name + '：' + ((1 - data.value) * 100) + '%'
                                }
                            },
                            itemStyle: placeHolderStyle
                        }
    ...
    $("#exportForecast").click(function() {
        ...
        setTimeout(function() {
            ...
            xhr.open('POST', admin.formatUrl("/api-edu/risk/riskPrediction/excel"), true);
