        ...
        var init = {
            ...
            input: function() {
                ...
                $(document).bind("click", function(e) {
                    if ($(e.target).closest(".layui-treeselect").length > 0) {
                        if ($(e.target).closest(".layui-select-title").length > 0 || $(e.target).closest(".layui-icon").length > 0) {
                            $('#treeSelect-div-' + tmp).removeClass('layui-unselect').addClass('layui-form-selected-new');
                        } else {
